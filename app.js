...
document.addEventListener('DOMContentLoaded', () => {
        ...
        for (let i = 0; i < catList.length; i++) {
            ...
            for (key in solution) {
                if (solution[key]['category'] == thisCat) {
                    ...
                    $('.tn_resultsSoftware .tn_resultsArray').append('<li class="result-m-data"><div class="tn_resultsArrayProduct"><h3><a href="#" class="link-modal-product">' + solution[key]['content'][0]['title'] + '</a></h3></div><div class="tn_resultsArrayCategory">' + catSubtitleText + '</div><div class="result-m-meta d-none" data-button="' + solution[key]['content'][0]['button'] + '" data-buttonurl="' + solution[key]['content'][0]['button_url'] + '" data-button2="' + solution[key]['content'][0]['button_2'] + '" data-buttonurl2="' + solution[key]['content'][0]['button_url_2'] + '" data-photo="' + solution[key]['content'][0]['photo'] + '" data-titlem="' + solution[key]['content'][0]['m_title'] + '" data-description="' + solution[key]['content'][0]['description'] + '"></div></li>');
                }
            }
        }
    }
    ...
    function printAppliance(a1, a2, a3) {
        ...
        for (let i = 0; i < catList.length; i++) {
            ...
            for (key in solution) {
                if (solution[key]['category'] == thisCat) {
                    $('.tn_resultsAppliance .tn_resultsContentArea').append('<div class="tn_resultsApplianceItem result-m-data"><div class="tn_resultsApplianceImage"><a href="#" class="link-modal-product"><img src="../../../../../c/dam/m/en_us/solutions/enterprise-networks/solution-builder/images/' + solution[key]['content'][0]['photo'] + '" alt="' + solution[key]['content'][0]['title'] + '"></a></div><div class="tn_resultsApplianceText"><h3><a href="#" class="link-modal-product">' + solution[key]['content'][0]['title'] + '</a></h3><p>' + solution[key]['content'][0]['description'] + '</p></div><div class="result-m-meta d-none" data-button="' + solution[key]['content'][0]['button'] + '" data-buttonurl="' + solution[key]['content'][0]['button_url'] + '" data-button2="' + solution[key]['content'][0]['button_2'] + '" data-buttonurl2="' + solution[key]['content'][0]['button_url_2'] + '" data-photo="' + solution[key]['content'][0]['photo'] + '" data-titlem="' + solution[key]['content'][0]['m_title'] + '" data-description="' + solution[key]['content'][0]['description_modal'] + '"></div></div>');
                }
            }
        }
    }
        ...
        for (let i = 0; i < catList.length; i++) {
            ...
            for (key in solution) {
                if (solution[key]['category'] == thisCat) {
                    ...
                    $('.tn_resultsInfrastructure .tn_resultsArray').append('<li class="result-m-data"><div class="tn_resultsArrayImage"><a href="#" class="link-modal-product"><img src="../../../../../c/dam/m/en_us/solutions/enterprise-networks/solution-builder/images/' + solution[key]['content'][0]['photo'] + '" alt="Product Image"></a></div><div class="tn_resultsArrayCategory">' + TEC[tecCat] + ':</div><div class="tn_resultsArrayProduct"><a href="#" class="link-modal-product">' + solution[key]['content'][0]['title'] + '</a></div><div class="result-m-meta d-none" data-button="' + solution[key]['content'][0]['button'] + '" data-buttonurl="' + solution[key]['content'][0]['button_url'] + '" data-button2="' + solution[key]['content'][0]['button_2'] + '" data-buttonurl2="' + solution[key]['content'][0]['button_url_2'] + '" data-photo="' + solution[key]['content'][0]['photo'] + '" data-titlem="' + solution[key]['content'][0]['m_title'] + '" data-description="' + solution[key]['content'][0]['description'] + '"></div></li>');
                }
            }
        }
    }
    ...
    function printServices(s1, s2, s3) {
        ...
        for (let i = 0; i < catList.length; i++) {
            ...
            for (key in solution) {
                if (solution[key]['category'] == thisCat) {
                    $('.tn_resultsServices .tn_resultsContentArea').append('<div class="tn_resultsServicesItem result-m-data"><h3><a class="link-modal-product" href="#">' + solution[key]['content'][0]['title'] + '</a></h3><div class="result-m-meta d-none" data-button="' + solution[key]['content'][0]['button'] + '" data-buttonurl="' + solution[key]['content'][0]['button_url'] + '" data-button2="' + solution[key]['content'][0]['button_2'] + '" data-buttonurl2="' + solution[key]['content'][0]['button_url_2'] + '" data-photo="' + solution[key]['content'][0]['photo'] + '" data-titlem="' + solution[key]['content'][0]['m_title'] + '" data-description="' + solution[key]['content'][0]['description_modal'] + '"></div><p class="result-m-description">' + solution[key]['content'][0]['description'] + '</p></div>');
                }
            }
        }
    }
    ...
    $(document).on('click', '.link-modal-product', function (event) {
        ...
        if (thisParentMetaPhoto) {
            productModal.find('#modal-photo').removeClass('d-none').html('<img src="../../../../../c/dam/m/en_us/solutions/enterprise-networks/solution-builder/images/' + thisParentMetaPhoto + '" alt="Product Photo">');
        }
